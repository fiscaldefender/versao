...
def InserirNfe(resumo=False, caminho=None, arquivo_xml=None, cnpj_resumo=None):
    ...
    if resumo == False:
        ...
        if verificar:
            ...
            db.executa_DML(f"""
                            INSERT INTO NFEDESTINADAS( NotaFiscal, Chave_Acesso, Situacao, DataEmissao, CNPJEmitente,Emitente, IEEmitente, Codigo_dest, Ambiente, NSU, tpnf, situacaomanifesto)
                            VALUES({numNota},'{chave_acesso_res}',{cSitNFe},'{dhEmi}','{cnpj_emit}','{xNome}','{ie}', {codigo_dest},1, '', {tpNF}, 0);""")

if __name__ == "__main__":
    
    InserirNfe(resumo=True, caminho=r'D:\old_consumoindevido\xml', arquivo_xml='52220102714977000791550050000840491744939626.xml')